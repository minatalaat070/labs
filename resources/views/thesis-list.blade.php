<x-layout>
	...
	@endphp
	@if($isAr)
	<h1 class="text-3xl font-medium title-font text-gray-900 mb-12 text-center">{{__('lab_theses')}} {{$lab->name_ar}} </h1>
	@else
	<h1 class="text-3xl font-medium title-font text-gray-900 mb-12 text-center">{{ucwords($lab->name)}} {{__('lab_theses')}}</h1>
	@endif

			...
			<div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2 mt-12">
				...
				<div class="flex justify-center">
					<div class="flex mt-24">
						<h1 class="text-gray-600 font-bold md:text-2xl text-xl">{{__('create_member')}}</h1>
					</div>
				</div>
				<form action="{{ route('create_member') }}" method="POST" enctype="multipart/form-data">
					@csrf
					...
					<div class="grid grid-cols-1 mt-5 mx-7">
						...
						<input class="py-2 px-3 rounded-lg border-2 border-purple-300 mt-1 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="url" name="staff_url" placeholder="http://www.example.com"/>
					</div>
					<div class="grid grid-cols-1 mt-5 mx-7">

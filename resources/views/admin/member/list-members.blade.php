		...
		<table class="w-full border">
			<thead>
				<tr class="bg-gray-50 border-b">
					...
					<th class="p-2 border-r cursor-pointer text-sm font-thin text-gray-500">
						<div class="flex items-center justify-center">
							{{__('member_about')}} <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewbox="0 0 24 24" stroke="currentColor">
								<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9l4-4 4 4m0 6l-4 4-4-4"></path></svg>
						</div>
					</th>
					<th class="p-2 border-r cursor-pointer text-sm font-thin text-gray-500">
				...
				<tr class="bg-gray-100 text-center border-b text-sm text-gray-600">
					...
					<td>
						<div class="inline-flex">
							<a  href="{{route("edit_member",$member->user_name)}}" class="my-4 mr-2 ml-4 bg-blue-500 p-2 text-white hover:shadow-lg text-xs font-thin">{{__("edit")}}</a>
							<form  class="my-4 mr-4 ml-2" method="POST" action="{{route("delete_lab",$member->lab->id)}}">
								@csrf
